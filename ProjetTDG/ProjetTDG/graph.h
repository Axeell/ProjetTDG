...
private :
    ...
    grman::WidgetText m_playtxt;

    grman::WidgetText m_pausetxt;

    grman::WidgetText m_savetxt;

    grman::WidgetText m_addtxt;

    grman::WidgetText m_quittxt;

    grman::WidgetText m_deletetxt;
...
public:
    ...
    Graph (GraphInterface *interface=nullptr) :
        m_interface(interface), m_quitter(false)  {  }
